# OpenAudioMc forked for docker support
This repository contains a GitHub action that aims to automate the creation of a Docker image for the client's website.
